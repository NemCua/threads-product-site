...
const releases = [
  {
    ...
    groups: [
      { name: "Bản vá", items: ["Cập nhật các bản sửa lỗi và cải thiện độ ổn định sau phiên bản 1.1.7.", "Thay thế hoàn toàn bản phát hành 1.1.8 chỉ dành cho Windows trước đó."] },
      { name: "macOS", items: ["Phát hành DMG và ZIP cho Mac Apple Silicon ARM64.", "Phát hành DMG và ZIP riêng cho Mac Intel x64."] },
      { name: "Windows", items: ["Phát hành bộ cài Setup mới cho Windows x64.", "Phát hành bản Portable mới cho Windows x64."] },
    ]
  },
  {
    version: "1.1.7", date: "19.08.2026", latest: false,
    title: "Bản vá mới cho macOS và Windows",
    summary: "Cập nhật phiên bản 1.1.7 mới cho cả macOS lẫn Windows, thay thế bản phát hành chỉ dành cho Windows trước đó.",
    groups: [
      { name: "Bản vá", items: ["Cập nhật các bản sửa lỗi và cải thiện độ ổn định sau phiên bản 1.1.6.", "Thay thế hoàn toàn bản phát hành 1.1.7 chỉ dành cho Windows trước đó."] },
      { name: "macOS", items: ["Phát hành DMG và ZIP cho Mac Apple Silicon ARM64.", "Phát hành DMG và ZIP riêng cho Mac Intel x64."] },
      { name: "Windows", items: ["Phát hành bộ cài Setup mới cho Windows x64.", "Phát hành bản Portable mới cho Windows x64."] },
    ]
  },
  {
    ...
    groups: [
      { name: "Bản vá", items: ["Cập nhật các bản sửa lỗi và cải thiện độ ổn định từ phiên bản 1.1.5.", "Tiếp tục đóng gói sẵn FFmpeg để người dùng không cần tự cài đặt."] },
      { name: "macOS", items: ["Phát hành DMG và ZIP riêng cho Mac Apple Silicon ARM64.", "Phát hành DMG và ZIP riêng cho Mac Intel x64."] },
      { name: "Windows", items: ["Cập nhật bộ cài Setup và phiên bản Portable cho Windows x64.", "Toàn bộ file phiên bản 1.1.6 được phân phối trực tiếp qua GitHub Releases."] },
    ]
  },
  {
    version: "1.1.5", date: "18.08.2026", latest: false,
  ...
  return <main><Header active="updates"/>
    ...
    <section className="shell releases">
      ...
      <div className="release-list">{releases.map((release,index)=><article className={`release ${release.latest?"current":""}`} id={`v-${release.version.replaceAll(".","-")}`} key={release.version}>
        ...
        <div className="release-action">{release.latest?<><Link className="button primary" href="/macos">Tải phiên bản mới nhất <span>→</span></Link><small>Có sẵn cho cả macOS và Windows.</small></>:<><span className="old-version-lock">⌁ Phiên bản cũ — không còn cung cấp tải xuống</span><small>Nội dung được giữ lại nhằm tham khảo lịch sử phát triển.</small></>}</div>
